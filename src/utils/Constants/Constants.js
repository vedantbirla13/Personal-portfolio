...
export const ProjectData = [
    ...
    },
    {
        image:Chatify,
        title:"Chatify",
        description :"Chatify is an end to end realtime messagin app where the user can login make friends by searching their name and start chatting in real-time. It also has a group chat feature where many people can chat at once",
