...
export const ProjectData = [
  ...
  // },
  {
    ...
    title: "Blog IT",
    description:
      "Blog it as the name describes is a website where users can login and write blogs. Whereas only the admins can approve the blogs and has full control over which blog to display and which to not",
  ...
  },
  {
    ...
    title: "Movie Time",
    description:
      "MovieTime is a website with collections of movies just like netflix, Where the user can toggle between categories such as Popular, top-rated & upcoming. User can alos fin useful links like IMDB etc ",
